      ...
      <div className="relative z-10 pt-40 pb-24 px-6 max-w-7xl mx-auto flex flex-col min-h-screen">
        <div className="mb-24 animate-in fade-in slide-in-from-bottom-12 duration-1000">
          <div className="inline-flex items-center space-x-3 px-4 py-1.5 bg-blue-500/10 border border-blue-500/20 rounded-full text-blue-400 mono text-[10px] tracking-[0.4em] uppercase mb-8">
            ...
            <span>SYSTEM_CORE_ENGAGED // v2.5.0</span>
          </div>
          
          <h1 className="text-8xl md:text-[10rem] font-black tracking-tighter uppercase leading-[0.85] mb-8">
            陈Alex<br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-blue-400 to-indigo-500">技术美术</span>
          </h1>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-end">
            <p className="text-gray-400 text-xl md:text-2xl leading-relaxed max-w-2xl font-light">
              在计算的精确性与艺术的感性之间寻找平衡。通过高效的 <span className="text-white font-medium">Shader 逻辑</span> 与 <span className="text-white font-medium">自动化流程</span>，定义次世代视觉体验。
            </p>
            <div className="flex flex-wrap gap-12 text-xs mono uppercase text-gray-500 tracking-[0.2em]">
              <div className="space-y-2">
                <span className="text-white/30 block">Location</span>
                <span className="text-white">SHANGHAI_CN</span>
              </div>
              <div className="space-y-2">
                <span className="text-white/30 block">Primary_Stack</span>
                <span className="text-white">REALTIME_RENDER</span>
              </div>
              <div className="space-y-2">
                <span className="text-white/30 block">Status</span>
                <span className="text-white animate-pulse">AVAILABLE_FOR_PROJECTS</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mt-auto mb-16">
          <ChipCard 
            ...
            num="01" 
            title="汽车视觉" 
            desc="从 CAD 到 WebGL 的极致还原。专注于高保真配置器与材质实时计算。" 
          ...
          <ChipCard 
            ...
            num="02" 
            title="AI 实验室" 
            desc="基于扩散模型的资产生成管线。探索 AIGC 在 3D 生产环境中的降本增效。" 
